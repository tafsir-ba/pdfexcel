...
export default function PrivacyPage() {
  return (
    <main className="legal-page">
      ...
      <h2>Files</h2>
      <p>PDF and spreadsheet contents are processed locally in your browser. PDF Batch does not upload, receive, or store the contents of those files.</p>
      ...
      <p>Stripe processes payment information and collects the email used for your receipt. PDF Batch stores that email, payment identifiers, and an optional password hash so you can sign in and restore paid access on other devices during the paid period. PDF and CSV file contents are never uploaded or stored.</p>
